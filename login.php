...
<html lang="en">
    ...
    <Script>
        window.alert('Welcome to Igurukul <?php echo $_SESSION['Username']; ?> ');
    </Script>
...
<section class="courses" id="lectures">
    <h1 class="heading">online <span>lectures</span></h1>
...
<div class="swiper course-slider">
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide slide">
            ...
            <img src="images/course-1.svg" alt="course1"></a>
            <h3>web development</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum doloremque</p>
        </div>
       
        <div class="swiper-slide slide">
            <a href="https://www.youtube.com/watch?v=VosXxEndc5M&list=PLmA1pQiCJQu1bmIpamH0O3nmEcaPJElok"target="_blank">
            <img src="images/course-2.svg" alt="course2"></a>
            <h3>science and biology</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum doloremque</p>
        </div>

        <div class="swiper-slide slide">
            <a href="https://www.youtube.com/watch?v=sTi5SNgxE3U&list=PLpQQipWcxwt9U7qgyYkvNH3Mp8XHXCMmQ"target="_blank">
            <img src="images/course-3.svg" alt="course3"></a>
            <h3>graphic design</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum doloremque</p>
        </div>

        <div class="swiper-slide slide">
            <a href="https://www.youtube.com/watch?v=sSryoRuJ7oE&list=PLp2XwX40sXwVX75o2FWoqVTorN5PJuPqY"target="_blank">
            <img src="images/course-4.svg" alt="course4"></a>
            <h3>teaching</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum doloremque</p>
        </div>
        
        <div class="swiper-slide slide">
            <a href="https://www.youtube.com/watch?v=ntLJmHOJ0ME&list=PLu0W_9lII9agS67Uits0UnJyrYiXhDS6q"target="_blank">
            <img src="images/course-5.svg" alt="course5"></a>
            <h3>engineering</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum doloremque</p>
        </div>

        <div class="swiper-slide slide">
            <a href="https://www.youtube.com/watch?v=bixR-KIJKYM&list=PLEiEAq2VkUULa5aOQmO_al2VVmhC-eqeI" target="_blank">
                <img src="images/course-6.svg" alt="course6"></a>
...
<!-- <section class="contact" id="contact">
    ...
    <div class="row">
        ...
        <form action="" method="post">
            ...
            <input type="number"required placeholder="enter your valid number" maxlength="9999999999" min="0" name="number" class="box" onkeypress="if(this.value.length == 10) return false;">
